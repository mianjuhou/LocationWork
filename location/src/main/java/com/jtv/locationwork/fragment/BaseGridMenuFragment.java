...
import com.jtv.base.activity.BaseGridViewFragment;
...
public class BaseGridMenuFragment extends BaseGridViewFragment implements OnItemClickListener {
	...
	public void data(Bundle savedInstanceState) {
		...
		if (menu != null && menu.size() > 0) {
			mAdapter = new MenuGridAdapter(getContext());
