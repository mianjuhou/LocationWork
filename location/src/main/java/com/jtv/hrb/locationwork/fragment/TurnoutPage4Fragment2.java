...
public class TurnoutPage4Fragment2 extends Fragment {
	...
	public TurnoutPage4Fragment2(TurnoutUiData turnoutUiData) {
	...
	private void setFocusChangeListener(EditText cell1,EditText cell2){
		...
		cell2.setOnFocusChangeListener(mOnFocusChangeListener2);
	}
		...
		public void onFocusChange(View v, boolean hasFocus) {
			...
			if(!hasFocus){
				if(!TextUtils.isEmpty(et.getText().toString().trim())){
					...
					activity.service.savePage4Data2(measureData);
				}
			}else{
	...
	private OnFocusChangeListener mOnFocusChangeListener2=new OnFocusChangeListener() {
		@Override
		public void onFocusChange(View v, boolean hasFocus) {
			EditText et=(EditText) v;
			if(!hasFocus){
				if(!TextUtils.isEmpty(et.getText().toString().trim())){
					...
					measureData.setStatus("0");
					measureData.setAssetattrid("ddd");
					measureData.setValue2(getEdtiTextNum(et));
					measureData.setGh(mUiData.partOrder+"");
