package com.jtv.base.ui.colordialog;
...
public class ColorPickerPalette extends TableLayout {
	...
	public void init(int size, int numColumns, ColorPickerSwatch.OnColorSelectedListener onColorSelectedListener) {
		...
		this.mDescription = resources.getString(R.string.color_swatch_description_selectedss);
		this.mDescriptionSelected = resources.getString(R.string.color_swatch_description_selectedss);
	}
}